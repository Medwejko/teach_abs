...
<div class="modal fade bd-example-modal-lg" id="newModal" tabindex="-1" role="dialog" aria-labelledby="taskModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<input type="hidden"  id="dmEdit" value="0">
			<div class="modal-body">
				<form id="newForm">
					...
					<div class="input-group mb-3" style="border: 1px solid #ced4da; border-radius: .25rem;">
						...
						<select class="form-control" aria-describedby="basic-addon2" name="test" id="soloselect-custom">
							<?php
					...
					<div class="input-group mb-3" style="border: 1px solid #ced4da; border-radius: .25rem;">
						<div class="input-group-prepend">
							<span class="input-group-text input-group-text-question" id="basic-addon2">Выберите проект</span>
						</div>
						<select class="form-control" aria-describedby="basic-addon2" name="project" id="soloselect-custom">
							<?php
