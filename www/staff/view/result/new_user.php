	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-primary" data-toggle="tooltip" title="Вывести отчет" data-project="<?php echo $_REQUEST['project'];?>" data-obj="test" id="resultsUserBtn">Вывести отчет</button>
			</div>
		</div>
	</div>
</div>
