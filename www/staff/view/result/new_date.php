	...
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
				...
				<form id="newForm">
					...
					<div class="input-group mb-3" style="border: 1px solid #ced4da; border-radius: .25rem;">
						<div class="input-group-prepend">
							<span class="input-group-text input-group-text-question" id="basic-addon2">Дата начала</span>
						</div>
						<input type="date" class="form-control" aria-describedby="basic-addon1"  name="dateIn" id="dateIn">
					</div>

					<div class="input-group mb-3" style="border: 1px solid #ced4da; border-radius: .25rem;">
						<div class="input-group-prepend">
							<span class="input-group-text input-group-text-question" id="basic-addon2">Дата окончания</span>
						</div>
						<input type="date" class="form-control" aria-describedby="basic-addon1"  name="dateOut" id="dateOut">
					</div>
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-primary" data-toggle="tooltip" title="Вывести отчет" data-test="<?php echo $_REQUEST['test'];?>" data-project="<?php echo $_REQUEST['project'];?>" data-obj="test" id="resultTestBtn">Вывести отчет</button>
			</div>
		</div>
	</div>
</div>
