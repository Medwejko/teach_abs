	...
	<table width="100%">
		<tr>
			<td align="left" width="220px">
				<button type="button" data-obj="subunit" data-toggle="tooltip" title="Добавить новое подразделение" class="btn btn-outline-primary newObjBtn">Добавить подразделение</button>	
			</td>
			<td width="65%" align="center"><b style="display:inline-block;">Поиск</b>
				<input style="display:inline-block; width:90%; border: 1px solid rgb(128, 189, 255);" type="text" class="form-control dsl-input" id="dsl-input" data-class="subunit" data-value="0" data-properties="['id','name']"  AUTOCOMPLETE="off">
	...
	<table class="table table-striped table-sm td-list">
		...
		<tbody>
			...
			foreach ($collection as $obj) 
			{
				...
				.'<td class="td-list">'.'<button type="button" class="btn btn-outline-secondary castom-menu-button editObjBtn" data-toggle="tooltip" data-placement="top" title="" data-original-title="Изменить подразделение" data-obj="subunit" data-id="'.$obj->id.'"><i class="material-icons">edit</i></button>'
				.'<button type="button" class="btn btn-outline-secondary castom-menu-button deleteElementBtn" data-id="'.$obj->id.'" data-obj="subunit" data-toggle="tooltip" data-placement="top" title="" data-original-title="Удалить подразделение"><i class="material-icons">delete_forever</i></button>'
				.'</td>'
				.'</tr>';
			};
			?>
