(function($){
	jQuery.fn.dynamicSelectListTest = function(){
							...
							success: function (data) {
								if (data.length>=1)
								{
									...
									$.each(data,function(i,item){
										...
										tr = tr +'<td><button type="button" class="btn btn-outline-secondary castom-menu-button editObjBtn" data-toggle="tooltip" data-placement="top" title="" data-original-title="Изменить тест" data-obj="test" data-id="' + item.id + '"><i class="material-icons">edit</i><button type="button" class="btn btn-outline-secondary castom-menu-button copyObjBtn" data-toggle="tooltip" data-placement="top" title="" data-original-title="Копировать тест" data-obj="test" data-id="' + item.id + '"><i class="material-icons">file_copy</i></button></button>&nbsp;<button type="button" class="btn btn-outline-secondary castom-menu-button deleteElementBtn" data-id="' + item.id + '" data-obj="test" data-toggle="tooltip" data-placement="top" title="" data-original-title="Удалить тест"><i class="material-icons">delete_forever</i></button></td><tr>';
										$('.tbds-list').append(tr);
									});
