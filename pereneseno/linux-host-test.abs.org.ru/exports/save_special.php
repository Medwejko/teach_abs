...
<td colspan=3 class=xl70 width=703 style='border-top:none;border-left:none;width:527pt'>Компетенции</td>
...
<td colspan=3 class=xl71 width=703 style='border-top:none;border-left:none;width:527pt'>Средний балл по всем компетенциям</td>";
if ($sumall1 > 0)
{
	switch (true) {
		case $sumall1 <= 0.1:
...
foreach ($balQuestion as $question => $answer) {
	...
	$body.="<tr height=86 style='mso-height-source:userset;height:64.5pt'>
	<td colspan=3 class=xl71 width=703 style='border-top:none;border-left:none;width:527pt'>". $question ."</td>";
	...
	foreach ($answer as $answer_text => $sum) 
	{
		...
		$body.="<tr height=86 style='mso-height-source:userset;height:64.5pt'>
		<td colspan=3 class=xl71 width=703 style='border-top:none;border-left:none;width:527pt'>". $answer_text ."</td>";
...
try {
	if((is_file("upload/report_special.xls"))) 
	{ 
		unlink("upload/report_special.xls"); 
		if(!file_exists("upload/report_special.xls"))
		{
			echo 'file is delete';
			file_put_contents('upload/report_special.xls', $document);
